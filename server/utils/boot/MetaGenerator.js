  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "AthenaLLM | Your personal LLM trained internal documents",
      },
      ...
      {
        tag: "meta",
        props: { property: "og:url", content: "https://athenallm.com" },
      },
      {
        tag: "meta",
        props: {
      ...
      {
        tag: "meta",
        props: { property: "twitter:url", content: "https://athenallm.com" },
      },
      {
        tag: "meta",
        props: {
    ...
    if (customTitle === null && faviconURL === null) {
      ...
      this.#customConfig = [
        ...
        },
        {
          ...
          content:
            customTitle ??
            "AthenaLLM | Your personal LLM trained internal documents",
        },
      ];
    }
