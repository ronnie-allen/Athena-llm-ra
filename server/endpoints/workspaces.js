...
function workspaceEndpoints(app) {
  ...
  app.post(
    "/workspace/:slug/upload/:selectedFolder",
    [
      validatedRequest,
    ...
    async function (request, response) {
      try {
        ...
        const { slug, selectedFolder } = request.params;
        if(selectedFolder && selectedFolder != "custom-documents"){
          const targetFolderPath = path.join(documentsPath, selectedFolder);
            ...
            if (currentFolder !== selectedFolder) {
              const sourcePath =
                process.env.NODE_ENV === "development"
                  ...
                  : path.join(documentsPath, normalizePath(doc.location));
              ...
              doc.location = path.join(selectedFolder, path.basename(doc.location));
