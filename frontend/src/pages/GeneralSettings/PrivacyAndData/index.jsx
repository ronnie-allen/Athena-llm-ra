  ...
  return (
    <div className="w-screen h-screen overflow-hidden bg-theme-bg-container flex">
      ...
      <div
        ...
        className="relative md:ml-[2px] md:mr-[16px] md:my-[16px] md:rounded-[16px] light:border light:border-theme-sidebar-border bg-theme-bg-secondary w-full h-full overflow-y-auto p-4 md:p-0"
      >
      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-y-2 border-b border-zinc-500/50 pb-4">
          ...
          <ul className="flex flex-col list-disc ml-4">
            {LLMSelection.description.map((desc, i) => (
              <li key={i} className="text-theme-text-secondary text-sm">
                {desc}
              </li>
            ))}
          </ul>
        ...
        <div className="flex flex-col gap-y-2 border-b border-zinc-500/50 pb-4">
          ...
          <ul className="flex flex-col list-disc ml-4">
            {EmbeddingEngine.description.map((desc, i) => (
              <li key={i} className="text-theme-text-secondary text-sm">
                {desc}
              </li>
            ))}
        ...
        <div className="flex flex-col gap-y-2 pb-4">
          ...
          <ul className="flex flex-col list-disc ml-4">
            {VectorDb.description.map((desc, i) => (
              <li key={i} className="text-theme-text-secondary text-sm">
                {desc}
              </li>
            ))}
...
//             look on{" "}
//             <a
//               href="https://github.com/search?q=repo%3AAthena%2Fathena%20.sendTelemetry(&type=code"
