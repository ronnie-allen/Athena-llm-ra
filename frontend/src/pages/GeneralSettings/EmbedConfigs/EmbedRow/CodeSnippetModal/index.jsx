...
https://github.com/Athena/athena/tree/master/embed/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/athena-chat-widget.min.js">
</script>
<!-- Athena (https://athena.com) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/Athena/athena/tree/master/embed/README.md"
          target="_blank"
