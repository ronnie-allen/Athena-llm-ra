...
const TITLE = "Welcome to Athena";
const DESCRIPTION = "Help us make Athena built for your needs. Optional.";
      ...
      <form onSubmit={handleSubmit} ref={formRef} className="">
        ...
        <div className="mt-8">
          ...
          <textarea
            ...
            placeholder="If you have any questions or comments right now, you can leave them here and we will get back to you. You can also email support@athena.com"
            wrap="soft"
            autoComplete="off"
          />
        </div>
