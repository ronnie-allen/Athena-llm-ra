...
import AthenaIcon from "@/media/logo/athena-icon.png";
...
export const VECTOR_DB_PRIVACY = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of Athena",
    ],
    logo: LanceDbLogo,
  },
};
...
export const EMBEDDING_ENGINE_PRIVACY = {
  native: {
    name: "Athena Embedder",
    description: [
      "Your document text is embedded privately on this instance of Athena",
    ],
    logo: AthenaIcon,
  },
  openai: {
...
export const FALLBACKS = {
  LLM: (provider) => ({
    name: "Unknown",
    description: [
      `"${provider}" has no known data handling policy defined in Athena`,
    ],
    logo: AthenaIcon,
  }),
  EMBEDDING: (provider) => ({
