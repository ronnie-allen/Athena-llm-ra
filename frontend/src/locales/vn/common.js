const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Chào mừng đến với ,  is an open-source AI tool by Athena that turns anything into a trained chatbot you can query and chat with.  is a BYOK (bring-your-own-keys) software so there is no subscription, fee, or charges for this software outside of the services you want to use with it.",
    part2:
      " is the easiest way to put powerful AI products like OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB, and other services together in a neat package with no fuss to increase your productivity by 100x.",
    part3:
      " can run totally locally on your machine with little overhead you wont even notice it's there! No GPU needed. Cloud and on-premises installation is available as well.\nThe AI tooling ecosystem gets more powerful everyday.  makes it easy to use.",
  ...
  llm: {
    ...
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. Its important these keys are current and correct or else  will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall  when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which  can use to process.",
    provider: {
      title: "Embedding Provider",
      description:
        "There is no set up required when using 's native embedding engine.",
    },
  },
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your  instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and  handle your data.",
    llm: "LLM Selection",
