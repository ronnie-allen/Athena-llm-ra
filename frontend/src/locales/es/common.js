const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Bienvenido a Athena, una herramienta de inteligencia artificial de código abierto creada por Athena que convierte cualquier cosa en un chatbot entrenado con el que puedes consultar y conversar. Athena es un software BYOK (bring-your-own-keys), por lo que no hay suscripciones, tarifas ni cargos por este software, salvo por los servicios que deseas utilizar.",
    part2:
      "Athena es la forma más sencilla de integrar productos de inteligencia artificial potentes como OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB y otros servicios en un paquete ordenado, sin complicaciones, para aumentar tu productividad en un 100x.",
    part3:
      "Athena puede ejecutarse completamente en tu máquina local con poco impacto, ¡ni siquiera notarás que está ahí! No se necesita GPU. También está disponible la instalación en la nube y en instalaciones locales.\nEl ecosistema de herramientas de inteligencia artificial se vuelve más poderoso cada día. Athena facilita su uso.",
  ...
  appearance: {
    ...
    message: {
      ...
      user: "usuario",
      message: "mensaje",
      assistant: "Asistente de chat Athena",
  ...
  api: {
    title: "Claves API",
    description:
      "Las claves API permiten al titular acceder y gestionar programáticamente esta instancia de Athena.",
  ...
  llm: {
    ...
    description:
      "Estas son las credenciales y configuraciones para tu proveedor preferido de chat y incrustación de LLM. Es importante que estas claves estén actualizadas y correctas, de lo contrario Athena no funcionará correctamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "El uso del modelo local Whisper en máquinas con RAM o CPU limitadas puede bloquear Athena al procesar archivos multimedia.",
    "warn-recommend":
  ...
  embedding: {
    ...
    provider: {
      ...
      description:
        "No se requiere configuración cuando se utiliza el motor de incrustación nativo de Athena.",
    },
  },
  ...
  vector: {
    ...
    description:
      "Estas son las credenciales y configuraciones para cómo funcionará tu instancia de Athena. Es importante que estas claves estén actualizadas y correctas.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protege tu instancia de Athena con una contraseña. Si olvidas esta contraseña, no hay método de recuperación, así que asegúrate de guardar esta contraseña.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Esta es tu configuración para cómo los proveedores de terceros conectados y Athena manejan tus datos.",
