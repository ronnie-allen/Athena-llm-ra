const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Willkommen bei Athena, Athena ist ein Open-Source-KI-Tool von Athena, das alles in einen trainierten Chatbot verwandelt, den Sie abfragen und mit dem Sie chatten können. Athena ist eine BYOK-Software (Bring-Your-Own-Keys), daher gibt es keine Abonnements, Gebühren oder Kosten für diese Software außerhalb der Dienste, die Sie damit nutzen möchten.",
    part2:
      "Athena ist der einfachste Weg, leistungsstarke KI-Produkte wie OpenAI, GPT-4, LangChain, PineconeDB, ChromaDB und andere Dienste in einem übersichtlichen Paket ohne Aufwand zusammenzufassen, um Ihre Produktivität um das 100-fache zu steigern.",
    part3:
      "Athena kann vollständig lokal auf Ihrem Computer mit geringem Overhead laufen - Sie werden nicht einmal bemerken, dass es da ist! Keine GPU erforderlich. Cloud- und On-Premises-Installation ist ebenfalls verfügbar.\nDas KI-Tool-Ökosystem wird jeden Tag leistungsfähiger. Athena macht es einfach, es zu nutzen.",
  ...
  appearance: {
    ...
    message: {
      ...
      user: "Benutzer",
      message: "Nachricht",
      assistant: "Athena Chat-Assistent",
  ...
  embedding: {
    ...
    provider: {
      ...
      description:
        "Bei Verwendung der nativen Einbettungs-Engine von Athena ist keine Einrichtung erforderlich.",
    },
  },
