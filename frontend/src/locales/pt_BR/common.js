const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Bem-vindo ao ,  é uma ferramenta de IA de código aberto da Athena que transforma qualquer coisa em um chatbot treinado que você pode consultar e conversar.  é um software BYOK (bring-your-own-keys | traga suas próprias chaves), portanto, não há assinatura, taxa ou cobranças para este software fora dos serviços que você deseja usar com ele.",
    part2:
      " é a maneira mais fácil de reunir produtos de IA poderosos como OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB e outros serviços em um pacote organizado sem complicações para aumentar sua produtividade em 100x.",
    part3:
      " pode ser executado totalmente localmente em sua máquina com pouca sobrecarga que você nem perceberá que está lá! Não é necessário GPU. A instalação em nuvem e localmente também está disponível.\nO ecossistema de ferramentas de IA fica mais poderoso a cada dia.  facilita o uso.",
  ...
  api: {
    title: "Chaves API",
    description:
      "As chaves API permitem que o titular acesse e gerencie programaticamente esta instância do .",
  ...
  llm: {
    ...
    description:
      "Estas são as credenciais e configurações para seu provedor preferido de chat e incorporação de LLM. É importante que essas chaves estejam atualizadas e corretas, caso contrário, o  não funcionará corretamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo whisper local em máquinas com RAM ou CPU limitados pode travar o  ao processar arquivos de mídia.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "A incorporação é o processo de transformar texto em vetores. Essas credenciais são necessárias para transformar seus arquivos e prompts em um formato que o  possa usar para processar.",
    provider: {
      title: "Provedor de Incorporação",
      description:
        "Não é necessária configuração ao usar o mecanismo de incorporação nativo do .",
    },
  },
  ...
  vector: {
    ...
    description:
      "Estas são as credenciais e configurações de como sua instância do  funcionará. É importante que essas chaves estejam atualizadas e corretas.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Proteja sua instância do  com uma senha. Se você esquecer esta senha, não há método de recuperação, então certifique-se de salvar esta senha.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Esta é a sua configuração de como os provedores de terceiros conectados e o  tratam seus dados.",
    llm: "Seleção de LLM",
