...
export const ONBOARDING_SURVEY_URL = "https://onboarding.athena.com";

export const AUTH_USER = "athena_user";
export const AUTH_TOKEN = "athena_authToken";
export const AUTH_TIMESTAMP = "athena_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "athena_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "athena_pinned_document_alert";
export const SEEN_WATCH_ALERT = "athena_watched_document_alert";

export const APPEARANCE_SETTINGS = "athena_appearance_settings";
