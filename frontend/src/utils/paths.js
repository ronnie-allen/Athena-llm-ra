...
export default {
  ...
  github: () => {
    return "https://github.com/Athena/athena";
  },
  discord: () => {
    return "https://discord.com/invite/6UyHPeGZAC";
  },
  docs: () => {
    return "https://docs.athena.com";
  },
  mailToAthena: () => {
    return "mailto:support@athena.com";
  },
  hosting: () => {
    return "https://my.athena.com/aio-checkout?product=athena";
  },
  workspace: {
    chat: (slug) => {
  ...
  communityHub: {
    ...
    noPrivateItems: () => {
      return "https://docs.athena.com/community-hub/faq#no-private-items";
    },
  },
