...
const SHOW_METRICS_KEY = "athena_show_chat_metrics";
const SHOW_METRICS_EVENT = "athena_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `athena_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `athena_show_chat_metrics` key
 * @returns {void}
 */
