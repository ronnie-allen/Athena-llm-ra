...
export default function DefaultChatContainer() {
  ...
  const [supportEmail, setSupportEmail] = useState(paths.mailToAthena());
  ...
  const popMsg = !window.localStorage.getItem("athena_intro");
  ...
  useEffect(() => {
    function processMsgs() {
      if (!!window.localStorage.getItem("athena_intro")) {
      ...
      window.localStorage.setItem("athena_intro", 1);
    }
